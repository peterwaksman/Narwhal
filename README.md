Narwhal does Natural Language Processing using key words and key narratives defined by the client. It uses methods of geometry and model-based recognition rather than statistics to define text aware classes that can read text from a narrow world and perform sentiment analysis or simple data extraction. 
