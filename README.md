...
Narwhal is a class library for Natural Language Processing in a "Narrow World". It uses client defined key words and key narratives to initialize text aware classes, applying methods of geometry rather than statistics. Narwhal classes can read text from a narrow world and perform sentiment analysis or plain text-to-data-structure conversion. 
