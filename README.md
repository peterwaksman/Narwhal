...
(See QuickStart.txt for tutorial.) Narwhal is a class library for Natural Language Processing in a "narrow world". It uses client defined key words and "key" narratives patterns to initialize text aware classes, applying methods of <i>geometry rather than statistics</i>. These classes can read text from a narrow world and perform sentiment analysis or plain text-to-data-structure conversion. 
